(function($) {
 ...
 // Parallax background
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2024/06/02', function(event) {
...
//   heart.classList.add('heart'); // Ensure consistent class application

//   let leftHeart = Math.floor(Math.random() * heartContainer.clientWidth);
//   let topHeart = Math.floor(Math.random() * heartContainer.clientHeight);
//   let widthHeart = Math.floor(Math.random() * 50);
...
//   heart.style.width = widthHeart + 'px';
//   heart.style.height = widthHeart + 'px';
//   heart.style.animationDuration = timeHeart + 's'; // Use seconds for duration
...
//   // Remove hearts after they've fallen out of view
//   document.addEventListener('animationend', function (event) {
//     if (event.animationName === 'animationHeart') {
...
// Google sheet
const scriptURL = 'https://script.google.com/macros/s/AKfycbxkQlD34nvHI-QMBDAu70VrwW-sNR8MnANPNLoEp9kLIs8IBn8Vv9972SMrP9E7AGxd/exec'
